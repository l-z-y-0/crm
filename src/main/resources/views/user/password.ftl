        ...
        <div class="layui-form layuimini-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="old_password" lay-verify="required" lay-reqtext="原始密码不能为空" placeholder="请输入旧的密码"  value="" class="layui-input">
                    <#--<tip>填写自己账号的旧的密码。</tip>-->
                </div>
            </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="password" name="new_password" lay-verify="required" lay-reqtext="修改密码不能为空" placeholder="请输入新的密码"  value="" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
